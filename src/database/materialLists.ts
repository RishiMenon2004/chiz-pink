...
export function getMaterialList(): {[key: string]: Material} { return allMaterials }

export function getInventoryList(): {[key: string]: Material} { return allInventoryMaterials }
